...
// generated from gentemplate [gentemplate -d Package=pg -id stream -d PoolType=stream_pool -d Type=Streamer -d Data=elts github.com/platinasystems/elib/pool.tmpl]
